...
.field private static volatile hasDisabledApplicationUninstallation:Z
...
.method private disablePaymentFrameworkUpdateRemoval()V
    ...
    sput-boolean v3, Lcom/android/server/spay/PaymentManagerService;->hasDisabledApplicationUninstallation:Z
...
.method public registerSPayFW(Landroid/spay/PaymentTZServiceConfig;)Landroid/spay/PaymentTZServiceCommnInfo;
    ...
    .line 197
    .local v6, "pid":I
    invoke-direct {p0, v5, v6}, Lcom/android/server/spay/PaymentManagerService;->getPackageNameFromPid(II)Ljava/lang/String;
    ...
    iput v0, v4, Landroid/spay/PaymentTZServiceCommnInfo;->mServiceVersion:I
    ...
    invoke-direct {v2, v3, v9, v10}, Lcom/android/server/spay/TAController;-><init>(Landroid/content/Context;ILandroid/spay/PaymentTZServiceConfig$TAConfig;)V

    .line 216
    .local v2, "taController":Landroid/os/IBinder;
    iget-object v3, v4, Landroid/spay/PaymentTZServiceCommnInfo;->mTAs:Ljava/util/Map;
    ...
    .end local p1    # "config":Landroid/spay/PaymentTZServiceConfig;
    .local v3, "config":Landroid/spay/PaymentTZServiceConfig;
    ...
    .line 221
    .local v1, "registeredFWKClient":Lcom/android/server/spay/PaymentManagerService$FrameworkClient;
    iget-object p1, v2, Lcom/android/server/spay/PaymentManagerService;->mRegisteredFWKClientMap:Ljava/util/Map;
    ...
    iget-object v0, v2, Lcom/android/server/spay/PaymentManagerService;->mRegisteredFWKClientMap:Ljava/util/Map;
