...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/system/keystore2/IKeystoreSecurityLevel$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist convertStorageKeyToEphemeral(Landroid/system/keystore2/KeyDescriptor;)Landroid/system/keystore2/EphemeralStorageKeyResponse;
    ...
    sget-object p0, Landroid/system/keystore2/EphemeralStorageKeyResponse;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/system/keystore2/EphemeralStorageKeyResponse;
    :try_end_0
    ...
    const-string p1, "Method convertStorageKeyToEphemeral is unimplemented."
...
.method public blacklist createOperation(Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;Z)Landroid/system/keystore2/CreateOperationResponse;
    ...
    invoke-static {p1, p2}, Lio/mesalabs/unica/KeyboxImitationHooks;->onCreateOperation(Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;)Landroid/system/keystore2/CreateOperationResponse;
    ...
    sget-object p0, Landroid/system/keystore2/CreateOperationResponse;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/system/keystore2/CreateOperationResponse;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string p1, "Method createOperation is unimplemented."
...
.method public blacklist deleteKey(Landroid/system/keystore2/KeyDescriptor;)V
    ...
    invoke-static {p1}, Lio/mesalabs/unica/KeyboxImitationHooks;->onDeleteKey(Landroid/system/keystore2/KeyDescriptor;)Z
    ...
    const-string p1, "Method deleteKey is unimplemented."
...
.method public blacklist generateKey(Landroid/system/keystore2/KeyDescriptor;Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;I[B)Landroid/system/keystore2/KeyMetadata;
    ...
    invoke-static {p1, p2, p3}, Lio/mesalabs/unica/KeyboxImitationHooks;->onGenerateKey(Landroid/system/keystore2/KeyDescriptor;Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;)Landroid/system/keystore2/KeyMetadata;
    ...
    sget-object p0, Landroid/system/keystore2/KeyMetadata;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    const-string p1, "Method generateKey is unimplemented."
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    sget-object p0, Landroid/system/keystore2/IKeystoreSecurityLevel$Stub$Proxy;->DESCRIPTOR:Ljava/lang/String;
...
.method public declared-synchronized blacklist getInterfaceHash()Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/system/keystore2/IKeystoreSecurityLevel$Stub$Proxy;->mCachedHash:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public blacklist getInterfaceVersion()I
    ...
    iput v2, p0, Landroid/system/keystore2/IKeystoreSecurityLevel$Stub$Proxy;->mCachedVersion:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :goto_0
    iget p0, p0, Landroid/system/keystore2/IKeystoreSecurityLevel$Stub$Proxy;->mCachedVersion:I
...
.method public blacklist importKey(Landroid/system/keystore2/KeyDescriptor;Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;I[B)Landroid/system/keystore2/KeyMetadata;
    ...
    invoke-static {p1, p3, p5}, Lio/mesalabs/unica/KeyboxImitationHooks;->onImportKey(Landroid/system/keystore2/KeyDescriptor;[Landroid/hardware/security/keymint/KeyParameter;[B)Landroid/system/keystore2/KeyMetadata;
    ...
    const-string p1, "Method importKey is unimplemented."
...
.method public blacklist importWrappedKey(Landroid/system/keystore2/KeyDescriptor;Landroid/system/keystore2/KeyDescriptor;[B[Landroid/hardware/security/keymint/KeyParameter;[Landroid/system/keystore2/AuthenticatorSpec;)Landroid/system/keystore2/KeyMetadata;
    ...
    const-string p1, "Method importWrappedKey is unimplemented."
