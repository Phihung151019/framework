...
.field private static blacklist mSplitBarMovedLeftWeight:F = -1.0f
...
.method public constructor whitelist <init>()V
    ...
    new-instance v1, Landroid/preference/PreferenceActivity$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Landroid/preference/PreferenceActivity$$ExternalSyntheticLambda0;-><init>(Landroid/preference/PreferenceActivity;)V

    iput-object v1, p0, Landroid/preference/PreferenceActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;

    new-instance v1, Landroid/preference/PreferenceActivity$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, Landroid/preference/PreferenceActivity$$ExternalSyntheticLambda1;-><init>(Landroid/preference/PreferenceActivity;)V

    iput-object v1, p0, Landroid/preference/PreferenceActivity;->mOnBackStackChangedListener:Landroid/app/FragmentManager$OnBackStackChangedListener;
...
.method private greylist postBindPreferences()V
    ...
    :cond_0
    iget-object p0, p0, Landroid/preference/PreferenceActivity;->mHandler:Landroid/os/Handler;
...
.method private greylist requirePreferenceManager()V
    ...
    const-string v0, "Modern two-pane PreferenceActivity requires use of a PreferenceFragment"
...
.method private greylist-max-o switchToHeaderInner(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, Landroid/preference/PreferenceActivity;->mInsideOnCreate:Z
    ...
    const-string v0, "Invalid fragment for this activity: "
...
.method greylist-max-o findBestMatchingHeader(Landroid/preference/PreferenceActivity$Header;Ljava/util/ArrayList;)Landroid/preference/PreferenceActivity$Header;
    ...
    iget-object v3, v1, Landroid/preference/PreferenceActivity$Header;->fragmentArguments:Landroid/os/Bundle;
    ...
    :cond_7
    iget-object v2, p1, Landroid/preference/PreferenceActivity$Header;->extras:Landroid/os/Bundle;

    if-eqz v2, :cond_8

    iget-object v2, p1, Landroid/preference/PreferenceActivity$Header;->extras:Landroid/os/Bundle;

    iget-object v3, v1, Landroid/preference/PreferenceActivity$Header;->extras:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v2, p1, Landroid/preference/PreferenceActivity$Header;->title:Ljava/lang/CharSequence;

    if-eqz v2, :cond_9

    iget-object v2, p1, Landroid/preference/PreferenceActivity$Header;->title:Ljava/lang/CharSequence;

    iget-object v3, v1, Landroid/preference/PreferenceActivity$Header;->title:Ljava/lang/CharSequence;
...
.method public whitelist findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iget-object p0, p0, Landroid/preference/PreferenceActivity;->mPreferenceManager:Landroid/preference/PreferenceManager;
...
.method public whitelist finishPreferencePanel(Landroid/app/Fragment;ILandroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/app/Fragment;->onActivityResult(IILandroid/content/Intent;)V
...
.method protected greylist-max-o getNextButton()Landroid/widget/Button;
    ...
    iget-object p0, p0, Landroid/preference/PreferenceActivity;->mNextButton:Landroid/widget/Button;
...
.method public whitelist isMultiPane()Z
    ...
    iget-boolean p0, p0, Landroid/preference/PreferenceActivity;->mSinglePane:Z
...
.method protected whitelist isValidFragment(Ljava/lang/String;)Z
    ...
    const-string p0, " has not checked if fragment "
...
.method public whitelist loadHeadersFromResource(ILjava/util/List;)V
    ...
    invoke-virtual {v13}, Landroid/preference/PreferenceActivity;->getResources()Landroid/content/res/Resources;
...
.method public whitelist onBuildStartFragmentIntent(Ljava/lang/String;Landroid/os/Bundle;II)Landroid/content/Intent;
    ...
    const-string p0, ":android:show_fragment_short_title"
...
.method protected whitelist onCreate(Landroid/os/Bundle;)V
    ...
    sget-object v1, Lcom/android/internal/R$styleable;->PreferenceActivity:[I
    ...
    invoke-virtual {p0, v2, v1, v3, v4}, Landroid/preference/PreferenceActivity;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    :goto_0
    iput-boolean v5, p0, Landroid/preference/PreferenceActivity;->mIsDeviceDefault:Z

    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0, v3}, Landroid/preference/PreferenceActivity;->setContentView(I)V
    ...
    iput-object v3, p0, Landroid/preference/PreferenceActivity;->mListFooter:Landroid/widget/FrameLayout;
    ...
    iput-object v3, p0, Landroid/preference/PreferenceActivity;->mPrefsContainer:Landroid/view/ViewGroup;
    ...
    iput-object v3, p0, Landroid/preference/PreferenceActivity;->mHeadersContainer:Landroid/view/ViewGroup;
    ...
    :goto_2
    iput-boolean v3, p0, Landroid/preference/PreferenceActivity;->mSinglePane:Z
    ...
    iget-boolean v8, p0, Landroid/preference/PreferenceActivity;->mIsDeviceDefault:Z
    ...
    iget-boolean v8, p0, Landroid/preference/PreferenceActivity;->mSinglePane:Z
    ...
    iput-object v8, p0, Landroid/preference/PreferenceActivity;->mSplitBarView:Landroid/view/View;

    if-eqz v8, :cond_4

    iget-object v8, p0, Landroid/preference/PreferenceActivity;->mHeadersContainer:Landroid/view/ViewGroup;
    ...
    iget-object v9, p0, Landroid/preference/PreferenceActivity;->mPrefsContainer:Landroid/view/ViewGroup;
    ...
    iget v11, v8, Landroid/widget/LinearLayout$LayoutParams;->weight:F

    iget v12, v9, Landroid/widget/LinearLayout$LayoutParams;->weight:F

    add-float/2addr v11, v12

    sget v12, Landroid/preference/PreferenceActivity;->mSplitBarMovedLeftWeight:F
    ...
    iget-object v11, p0, Landroid/preference/PreferenceActivity;->mHeadersContainer:Landroid/view/ViewGroup;

    invoke-virtual {v11, v8}, Landroid/view/ViewGroup;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v8, p0, Landroid/preference/PreferenceActivity;->mPrefsContainer:Landroid/view/ViewGroup;
    ...
    const-class v8, Landroid/preference/PreferenceActivity$Header;

    invoke-virtual {p1, v5, v8}, Landroid/os/Bundle;->getParcelableArrayList(Ljava/lang/String;Ljava/lang/Class;)Ljava/util/ArrayList;
    ...
    const-string v5, ":android:cur_header"
    ...
    invoke-virtual {p0, p1, v2}, Landroid/preference/PreferenceActivity;->showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v3, v5}, Landroid/preference/PreferenceActivity;->switchToHeader(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-boolean p1, p0, Landroid/preference/PreferenceActivity;->mIsDeviceDefault:Z
    ...
    :goto_5
    invoke-virtual {p0, p1, v5}, Landroid/preference/PreferenceActivity;->showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p1, p0, v1}, Landroid/preference/PreferenceManager;-><init>(Landroid/app/Activity;I)V
    ...
    new-instance v2, Landroid/preference/PreferenceActivity$2;

    invoke-direct {v2, p0}, Landroid/preference/PreferenceActivity$2;-><init>(Landroid/preference/PreferenceActivity;)V
    ...
    invoke-direct {v3, p0}, Landroid/preference/PreferenceActivity$3;-><init>(Landroid/preference/PreferenceActivity;)V
    ...
    iput-object v3, p0, Landroid/preference/PreferenceActivity;->mNextButton:Landroid/widget/Button;
    ...
    iget-object v3, p0, Landroid/preference/PreferenceActivity;->mNextButton:Landroid/widget/Button;
    ...
    invoke-virtual {p1, v1}, Landroid/app/FragmentManager;->addOnBackStackChangedListener(Landroid/app/FragmentManager$OnBackStackChangedListener;)V
    ...
    invoke-virtual {p1}, Landroid/preference/Preference;->isRTL()Z

    move-result v1

    if-eqz v1, :cond_1a

    invoke-virtual {p1}, Landroid/preference/Preference;->hasRTL()Z
    ...
    iget-object p1, p0, Landroid/preference/PreferenceActivity;->mSplitBarView:Landroid/view/View;

    if-eqz p1, :cond_1c

    iget-object p1, p0, Landroid/preference/PreferenceActivity;->mSplitBarLayoutChangeListner:Landroid/view/View$OnLayoutChangeListener;

    if-nez p1, :cond_1b

    new-instance p1, Landroid/preference/PreferenceActivity$5;

    invoke-direct {p1, p0}, Landroid/preference/PreferenceActivity$5;-><init>(Landroid/preference/PreferenceActivity;)V

    iput-object p1, p0, Landroid/preference/PreferenceActivity;->mSplitBarLayoutChangeListner:Landroid/view/View$OnLayoutChangeListener;
    ...
    new-instance v0, Landroid/preference/PreferenceActivity$6;

    invoke-direct {v0, p0}, Landroid/preference/PreferenceActivity$6;-><init>(Landroid/preference/PreferenceActivity;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    :cond_1c
    iput-boolean v4, p0, Landroid/preference/PreferenceActivity;->mInsideOnCreate:Z
...
.method public whitelist onGetInitialHeader()Landroid/preference/PreferenceActivity$Header;
    ...
    const-string v0, "Must have at least one header with a fragment"
...
.method public whitelist onIsMultiPane()Z
    ...
    iget-boolean p0, p0, Landroid/preference/PreferenceActivity;->mIsMultiPane:Z
...
.method protected whitelist onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Landroid/preference/PreferenceManager;->dispatchNewIntent(Landroid/content/Intent;)V
...
.method protected whitelist onStop()V
    ...
    invoke-virtual {p0}, Landroid/preference/PreferenceManager;->dispatchActivityStop()V
...
.method public whitelist setListFooter(Landroid/view/View;)V
    ...
    iget-object p0, p0, Landroid/preference/PreferenceActivity;->mListFooter:Landroid/widget/FrameLayout;
...
.method public whitelist setParentTitle(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)V
    ...
    iget-object p0, p0, Landroid/preference/PreferenceActivity;->mFragmentBreadCrumbs:Landroid/app/FragmentBreadCrumbs;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1, p2, p3}, Landroid/app/FragmentBreadCrumbs;->setParentTitle(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)V
...
.method public whitelist startPreferenceFragment(Landroid/app/Fragment;Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/app/FragmentTransaction;->setTransition(I)Landroid/app/FragmentTransaction;
...
.method public whitelist startPreferencePanel(Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;Landroid/app/Fragment;I)V
    ...
    invoke-virtual {p0, p3}, Landroid/app/FragmentTransaction;->setBreadCrumbTitle(I)Landroid/app/FragmentTransaction;
    ...
    invoke-virtual {p0, p4}, Landroid/app/FragmentTransaction;->setBreadCrumbTitle(Ljava/lang/CharSequence;)Landroid/app/FragmentTransaction;
...
.method public whitelist switchToHeader(Landroid/preference/PreferenceActivity$Header;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/FragmentManager;->popBackStack(Ljava/lang/String;I)V
    ...
    const-string p1, "can\'t switch to header that has no fragment"
