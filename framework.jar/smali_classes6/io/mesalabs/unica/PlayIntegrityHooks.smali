...
.field private static final blacklist PIF_BRAND:Ljava/lang/String; = "null"

.field private static final blacklist PIF_DEVICE:Ljava/lang/String; = "null"

.field private static final blacklist PIF_DEVICE_INITIAL_SDK_INT:Ljava/lang/String; = "null"

.field private static final blacklist PIF_FINGERPRINT:Ljava/lang/String; = "google/shiba_beta/shiba:CANARY/ZP11.251121.010/14518957:user/release-keys"
...
.field private static final blacklist PIF_MANUFACTURER:Ljava/lang/String; = "null"

.field private static final blacklist PIF_MODEL:Ljava/lang/String; = "null"

.field private static final blacklist PIF_PRODUCT:Ljava/lang/String; = "null"
...
.field private static final blacklist PIF_VERSION:Ljava/lang/String; = "20251212"
...
.method private static blacklist isPIFEnabled()Z
    ...
    const-string/jumbo v0, "persist.sys.unica.pif"
...
.method public static blacklist onEngineGetCertificateChain()V
    ...
    :cond_0
    invoke-static {}, Lio/mesalabs/unica/PlayIntegrityHooks;->shouldBlockKeyAttestation()Z

    move-result v0

    if-eqz v0, :cond_1

    const-string v0, "Key attestation blocking is disabled because a keybox is defined to spoof"
...
.method private static blacklist shouldBlockKeyAttestation()Z
    .locals 2

    const-string/jumbo v0, "persist.sys.unica.pif.block_attest_key"
...
.method public static blacklist shouldBypassTaskPermission(Landroid/content/Context;)Z
    ...
    const-string/jumbo v0, "shouldBypassTaskPermission: gmsUid:"
    ...
    const-string/jumbo v1, "shouldBypassTaskPermission: unable to get gms uid"
...
.method private static blacklist spoofBuildGms()V
    ...
    const-string/jumbo v0, "persist.sys.pif.product"
    ...
    :cond_0
    const-string/jumbo v0, "persist.sys.pif.device"
    ...
    :cond_1
    const-string/jumbo v0, "persist.sys.pif.manufacturer"
    ...
    :cond_2
    const-string/jumbo v0, "persist.sys.pif.brand"
    ...
    :cond_3
    const-string/jumbo v0, "persist.sys.pif.model"
    ...
    :cond_4
    const-string/jumbo v0, "persist.sys.pif.release"
    ...
    :cond_5
    const-string/jumbo v0, "persist.sys.pif.incremental"
    ...
    :cond_6
    const-string/jumbo v0, "persist.sys.pif.id"
    ...
    :cond_7
    const-string/jumbo v0, "persist.sys.pif.fingerprint"

    const-string v2, "google/shiba_beta/shiba:CANARY/ZP11.251121.010/14518957:user/release-keys"
    ...
    :cond_8
    const-string/jumbo v0, "persist.sys.pif.security_patch"
    ...
    :cond_9
    const-string/jumbo v0, "persist.sys.pif.first_api_level"
