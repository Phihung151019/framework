...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Lorg/apache/commons/math3/util/TransformerMap;

    .line 163
    .local v1, "rhs":Lorg/apache/commons/math3/util/TransformerMap;
    ...
    iget-object v4, v1, Lorg/apache/commons/math3/util/TransformerMap;->defaultTransformer:Lorg/apache/commons/math3/util/NumberTransformer;
    ...
    iget-object v4, v1, Lorg/apache/commons/math3/util/TransformerMap;->map:Ljava/util/Map;
    ...
    .line 170
    .local v4, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Class<*>;Lorg/apache/commons/math3/util/NumberTransformer;>;"
    invoke-interface {v4}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lorg/apache/commons/math3/util/NumberTransformer;

    iget-object v6, v1, Lorg/apache/commons/math3/util/TransformerMap;->map:Ljava/util/Map;
    ...
    .line 173
    .end local v4    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Class<*>;Lorg/apache/commons/math3/util/NumberTransformer;>;"
    :cond_3
    goto :goto_0
    ...
    .line 176
    .end local v1    # "rhs":Lorg/apache/commons/math3/util/TransformerMap;
    :cond_5
    return v2
.end method
...
.method public transform(Ljava/lang/Object;)D
    ...
    invoke-virtual {p0, v2}, Lorg/apache/commons/math3/util/TransformerMap;->getTransformer(Ljava/lang/Class;)Lorg/apache/commons/math3/util/NumberTransformer;

    move-result-object v2

    .line 147
    .local v2, "trans":Lorg/apache/commons/math3/util/NumberTransformer;
    if-eqz v2, :cond_2

    .line 148
    invoke-interface {v2, p1}, Lorg/apache/commons/math3/util/NumberTransformer;->transform(Ljava/lang/Object;)D
    ...
    .line 144
    .end local v2    # "trans":Lorg/apache/commons/math3/util/NumberTransformer;
    :cond_1
    :goto_0
    iget-object v2, p0, Lorg/apache/commons/math3/util/TransformerMap;->defaultTransformer:Lorg/apache/commons/math3/util/NumberTransformer;
