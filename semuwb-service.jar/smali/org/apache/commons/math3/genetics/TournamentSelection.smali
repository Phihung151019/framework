...
.method private tournament(Lorg/apache/commons/math3/genetics/ListPopulation;)Lorg/apache/commons/math3/genetics/Chromosome;
    ...
    .line 85
    .local v0, "tournamentPopulation":Lorg/apache/commons/math3/genetics/ListPopulation;
    ...
    .line 86
    .local v1, "chromosomes":Ljava/util/List;, "Ljava/util/List<Lorg/apache/commons/math3/genetics/Chromosome;>;"
    const/4 v2, 0x0
    ...
    invoke-virtual {v0, v4}, Lorg/apache/commons/math3/genetics/ListPopulation;->addChromosome(Lorg/apache/commons/math3/genetics/Chromosome;)V
    ...
    .line 72
    .end local v0    # "tournamentPopulation":Lorg/apache/commons/math3/genetics/ListPopulation;
    .end local v1    # "chromosomes":Ljava/util/List;, "Ljava/util/List<Lorg/apache/commons/math3/genetics/Chromosome;>;"
    :cond_1
...
.method public select(Lorg/apache/commons/math3/genetics/Population;)Lorg/apache/commons/math3/genetics/ChromosomePair;
    ...
    check-cast v1, Lorg/apache/commons/math3/genetics/ListPopulation;

    invoke-direct {p0, v1}, Lorg/apache/commons/math3/genetics/TournamentSelection;->tournament(Lorg/apache/commons/math3/genetics/ListPopulation;)Lorg/apache/commons/math3/genetics/Chromosome;

    move-result-object v1

    move-object v2, p1

    check-cast v2, Lorg/apache/commons/math3/genetics/ListPopulation;

    invoke-direct {p0, v2}, Lorg/apache/commons/math3/genetics/TournamentSelection;->tournament(Lorg/apache/commons/math3/genetics/ListPopulation;)Lorg/apache/commons/math3/genetics/Chromosome;
