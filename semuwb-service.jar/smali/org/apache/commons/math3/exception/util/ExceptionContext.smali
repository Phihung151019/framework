...
.method private buildMessage(Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 172
    .local v1, "count":I
    iget-object v2, p0, Lorg/apache/commons/math3/exception/util/ExceptionContext;->msgPatterns:Ljava/util/List;
    ...
    .line 175
    .local v4, "pat":Lorg/apache/commons/math3/exception/util/Localizable;
    ...
    invoke-direct {v6, v7, p1}, Ljava/text/MessageFormat;-><init>(Ljava/lang/String;Ljava/util/Locale;)V

    .line 178
    .local v6, "fmt":Ljava/text/MessageFormat;
    ...
    .line 173
    .end local v4    # "pat":Lorg/apache/commons/math3/exception/util/Localizable;
    .end local v5    # "args":[Ljava/lang/Object;
    .end local v6    # "fmt":Ljava/text/MessageFormat;
    :cond_0
...
.method private deSerializeMessages(Ljava/io/ObjectInputStream;)V
    ...
    check-cast v2, Lorg/apache/commons/math3/exception/util/Localizable;

    .line 265
    .local v2, "pat":Lorg/apache/commons/math3/exception/util/Localizable;
    ...
    .line 262
    .end local v2    # "pat":Lorg/apache/commons/math3/exception/util/Localizable;
    .end local v3    # "aLen":I
...
.method private serializeContext(Ljava/io/ObjectOutputStream;)V
    ...
    .line 288
    iget-object v1, p0, Lorg/apache/commons/math3/exception/util/ExceptionContext;->context:Ljava/util/Map;
