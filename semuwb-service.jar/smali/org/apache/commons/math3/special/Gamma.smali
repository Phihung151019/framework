...
.method public static gamma(D)D
    ...
    invoke-static {v9, v10}, Lorg/apache/commons/math3/special/Gamma;->invGamma1pm1(D)D
    ...
    .line 696
    :cond_3
    invoke-static {v7, v8}, Lorg/apache/commons/math3/special/Gamma;->invGamma1pm1(D)D
...
.method public static invGamma1pm1(D)D
    ...
    .line 554
    .local v35, "a":D
    const-wide v33, 0x3deae78bd35ee299L    # 1.9575583661463974E-10

    .line 555
    .local v33, "b":D
    const-wide v37, -0x418faf7df74a0d96L    # -6.077618957228252E-8

    mul-double v39, v2, v33
    ...
    .end local v0    # "ret":D
    :cond_2
    const-wide v35, 0x3cf38fbfc319a348L    # 4.343529937408594E-15

    .line 585
    .local v35, "p":D
    const-wide v37, -0x42be6a698dd6c299L    # -1.2494415722763663E-13
    ...
    .end local v37    # "p":D
    .restart local v39    # "p":D
    mul-double v35, v2, v39

    add-double v35, v35, v33

    .line 592
    .end local v39    # "p":D
    .restart local v35    # "p":D
    const-wide v33, 0x3f31a50be16f20f5L    # 2.6923694661863613E-4

    .line 593
    .local v33, "q":D
    const-wide v37, 0x3f744d9cf2512520L    # 0.004956830093825887
...
.method public static lanczos(D)D
    ...
    .line 523
    .local v0, "sum":D
    sget-object v2, Lorg/apache/commons/math3/special/Gamma;->LANCZOS:[D
...
.method public static logGamma(D)D
    ...
    invoke-static {v3, v4}, Lorg/apache/commons/math3/special/Gamma;->logGamma1p(D)D
    ...
    sget-wide v6, Lorg/apache/commons/math3/special/Gamma;->HALF_LOG_2_PI:D
...
.method public static regularizedGammaP(DDDI)D
    ...
    .end local v3    # "ret":D
    :cond_5
    new-instance v3, Lorg/apache/commons/math3/exception/MaxCountExceededException;

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v4

    invoke-direct {v3, v4}, Lorg/apache/commons/math3/exception/MaxCountExceededException;-><init>(Ljava/lang/Number;)V
...
.method public static regularizedGammaQ(DDDI)D
    ...
    .end local v0    # "ret":D
    :cond_2
    new-instance v0, Lorg/apache/commons/math3/special/Gamma$1;

    invoke-direct {v0, p0, p1}, Lorg/apache/commons/math3/special/Gamma$1;-><init>(D)V

    .line 418
    .local v0, "cf":Lorg/apache/commons/math3/util/ContinuedFraction;
    move-wide v1, p2
    ...
    .line 394
    .end local v0    # "cf":Lorg/apache/commons/math3/util/ContinuedFraction;
    .end local v3    # "ret":D
    :cond_3
    :goto_0
    const-wide/high16 v3, 0x7ff8000000000000L    # Double.NaN
