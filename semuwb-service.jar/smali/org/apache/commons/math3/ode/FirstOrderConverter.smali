...
.method public computeDerivatives(D[D[D)V
    ...
    iget v3, p0, Lorg/apache/commons/math3/ode/FirstOrderConverter;->dimension:I

    invoke-static {p3, v0, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 106
    iget-object v4, p0, Lorg/apache/commons/math3/ode/FirstOrderConverter;->equations:Lorg/apache/commons/math3/ode/SecondOrderDifferentialEquations;

    iget-object v7, p0, Lorg/apache/commons/math3/ode/FirstOrderConverter;->z:[D

    iget-object v8, p0, Lorg/apache/commons/math3/ode/FirstOrderConverter;->zDot:[D

    iget-object v9, p0, Lorg/apache/commons/math3/ode/FirstOrderConverter;->zDDot:[D

    move-wide v5, p1

    .end local p1    # "t":D
    .local v5, "t":D
    invoke-interface/range {v4 .. v9}, Lorg/apache/commons/math3/ode/SecondOrderDifferentialEquations;->computeSecondDerivatives(D[D[D[D)V
    ...
    invoke-static {p1, v2, p4, p2, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
