...
.method protected next(I)I
    ...
    iget-object v1, v0, Lorg/apache/commons/math3/random/Well44497b;->iRm1:[I

    iget v2, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I

    aget v1, v1, v2

    .line 88
    .local v1, "indexRm1":I
    iget-object v2, v0, Lorg/apache/commons/math3/random/Well44497b;->iRm2:[I

    iget v3, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I

    aget v2, v2, v3

    .line 90
    .local v2, "indexRm2":I
    iget-object v3, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I

    iget v4, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I

    aget v3, v3, v4

    .line 91
    .local v3, "v0":I
    iget-object v4, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I

    iget-object v5, v0, Lorg/apache/commons/math3/random/Well44497b;->i1:[I

    iget v6, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I
    ...
    .line 92
    .local v4, "vM1":I
    iget-object v5, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I

    iget-object v6, v0, Lorg/apache/commons/math3/random/Well44497b;->i2:[I

    iget v7, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I
    ...
    .line 93
    .local v5, "vM2":I
    iget-object v6, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I

    iget-object v7, v0, Lorg/apache/commons/math3/random/Well44497b;->i3:[I

    iget v8, v0, Lorg/apache/commons/math3/random/Well44497b;->index:I
    ...
    .line 96
    .local v6, "vM3":I
    iget-object v7, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I

    aget v7, v7, v1

    and-int/lit16 v7, v7, -0x8000

    iget-object v8, v0, Lorg/apache/commons/math3/random/Well44497b;->v:[I
