.class public Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;
.super Lcom/samsung/android/camerax/advanced/extender/BaseAdvancedExtender;
.source "AutoAdvancedExtender.java"


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender$AutoSessionProcessor;
    }
.end annotation


# static fields
.field private static final EXTENSION_ID:I = 0x1
...
.method public createSessionProcessor()Landroidx/camera/extensions/impl/advanced/SessionProcessorImpl;
    ...
    .line 106
    new-instance v0, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender$AutoSessionProcessor;

    invoke-direct {v0, p0}, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender$AutoSessionProcessor;-><init>(Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;)V
...
.method public getSupportedCaptureOutputResolutions(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v1, v2, v2}, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public getSupportedPreviewOutputResolutions(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v2, v1}, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public getSupportedYuvAnalysisResolutions(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 94
    iget-object v0, p0, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;->mCameraCharacteristics:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-virtual {p0, v2, v1, v3}, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public isExtensionAvailable(Ljava/lang/String;Ljava/util/Map;)Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/samsung/android/camerax/advanced/extender/AutoAdvancedExtender;->TAG:Ljava/lang/String;
