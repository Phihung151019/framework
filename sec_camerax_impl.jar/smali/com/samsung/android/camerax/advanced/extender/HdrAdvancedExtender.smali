.class public Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender$HdrSessionProcessor;
    }
.end annotation


# static fields
.field private static final EXTENSION_ID:I = 0x2
...
.method public constructor <init>()V
    ...
    .line 48
    invoke-virtual {v0, v1}, Lcom/samsung/android/camerax/advanced/extender/internal/ExtensionProperty$Builder;->setHdrMode(I)Lcom/samsung/android/camerax/advanced/extender/internal/ExtensionProperty$Builder;
...
.method public createSessionProcessor()Landroidx/camera/extensions/impl/advanced/SessionProcessorImpl;
    ...
    .line 107
    new-instance v0, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender$HdrSessionProcessor;

    invoke-direct {v0, p0}, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender$HdrSessionProcessor;-><init>(Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;)V
...
.method public getSupportedCaptureOutputResolutions(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v1, v2, v2}, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public getSupportedPreviewOutputResolutions(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v2, v1}, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public getSupportedYuvAnalysisResolutions(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 95
    iget-object v0, p0, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;->mCameraCharacteristics:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-virtual {p0, v2, v1, v3}, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;->filterOutputResolutions(Ljava/util/List;Landroid/util/Size;Landroid/util/Size;)Ljava/util/Map;
...
.method public isExtensionAvailable(Ljava/lang/String;Ljava/util/Map;)Z
    ...
    invoke-static {v0}, Lcom/samsung/android/camerax/advanced/util/CameraCharacteristicsUtil;->isAvailableHDR(Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/samsung/android/camerax/advanced/extender/HdrAdvancedExtender;->TAG:Ljava/lang/String;
