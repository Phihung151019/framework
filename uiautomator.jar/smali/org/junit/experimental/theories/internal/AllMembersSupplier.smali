...
.method private addMultiPointFields(Lorg/junit/experimental/theories/ParameterSignature;Ljava/util/List;)V
    ...
    .end local p1    # "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .end local p2    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    .local v4, "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .local v6, "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    ...
    .line 110
    .end local v4    # "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .end local v6    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    .restart local p1    # "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .restart local p2    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    :cond_0
    return-void
.end method
...
.method private addMultiPointMethods(Lorg/junit/experimental/theories/ParameterSignature;Ljava/util/List;)V
    ...
    .line 86
    .end local p2    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    .restart local v4    # "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .restart local v6    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    .local p1, "throwable":Ljava/lang/Throwable;
    :goto_1
    ...
    .line 87
    .local p2, "annotation":Lorg/junit/experimental/theories/DataPoints;
    if-eqz p2, :cond_2
    ...
    invoke-static {v0, p1}, Lorg/junit/experimental/theories/internal/AllMembersSupplier;->isAssignableToAnyOf([Ljava/lang/Class;Ljava/lang/Object;)Z
    ...
    .end local v4    # "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .end local v6    # "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    .local p1, "sig":Lorg/junit/experimental/theories/ParameterSignature;
    .local p2, "list":Ljava/util/List;, "Ljava/util/List<Lorg/junit/experimental/theories/PotentialAssignment;>;"
    :cond_3
    move-object v4, p1
...
.method private addSinglePointMethods(Lorg/junit/experimental/theories/ParameterSignature;Ljava/util/List;)V
    ...
    invoke-direct {v2, v1, v3}, Lorg/junit/experimental/theories/internal/AllMembersSupplier$MethodParameterValue;-><init>(Lorg/junit/runners/model/FrameworkMethod;Lorg/junit/experimental/theories/internal/AllMembersSupplier-IA;)V
