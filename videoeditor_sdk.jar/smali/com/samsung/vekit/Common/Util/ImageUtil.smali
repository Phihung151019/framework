...
.field private static sampleSize:I
...
.method public static decodeImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    .line 69
    const-string v0, "can\'t decode image file"
    ...
    .line 101
    :pswitch_1
    invoke-virtual {v7, v6, v8}, Landroid/graphics/Matrix;->setScale(FF)V
    ...
    .line 91
    :pswitch_6
    invoke-virtual {v7, v8, v6}, Landroid/graphics/Matrix;->setScale(FF)V
    ...
    invoke-static {v2, v3}, Lcom/samsung/vekit/Common/Util/ImageUtil;->convert(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v3}, Lcom/samsung/vekit/Common/Util/ImageUtil;->convert(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method private static decodeImageBySkia(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    .locals 3
    .param p0, "filepath"    # Ljava/lang/String;
    .param p1, "targetWidth"    # I
    .param p2, "targetHeight"    # I
...
.method private static getAttribute(Landroid/media/ExifInterface;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method public static getSampleSize()I
    .locals 1
...
.method public static parseImage(Ljava/lang/String;)Lcom/samsung/vekit/Common/Object/ImageInfo;
    .locals 6
    .param p0, "filePath"    # Ljava/lang/String;
