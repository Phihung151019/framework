...
.method private eglSetup()V
    ...
    .line 77
    .local v8, "configs":[Landroid/opengl/EGLConfig;
    new-array v11, v4, [I

    .line 78
    .local v11, "numConfigs":[I
    ...
    invoke-static {v3, v5, v7, v1, v0}, Landroid/opengl/EGL14;->eglCreateContext(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;

    move-result-object v3

    iput-object v3, p0, Lcom/samsung/android/transcode/surfaces/InputSurface;->mEGLContext:Landroid/opengl/EGLContext;

    .line 89
    const-string v3, "eglCreateContext"

    invoke-direct {p0, v3}, Lcom/samsung/android/transcode/surfaces/InputSurface;->checkEglError(Ljava/lang/String;)V
    ...
    iget-object v7, p0, Lcom/samsung/android/transcode/surfaces/InputSurface;->mSurface:Landroid/view/Surface;

    invoke-static {v4, v5, v7, v3, v0}, Landroid/opengl/EGL14;->eglCreateWindowSurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Ljava/lang/Object;[II)Landroid/opengl/EGLSurface;
    ...
    .end local v8    # "configs":[Landroid/opengl/EGLConfig;
    .end local v11    # "numConfigs":[I
    :cond_3
    const/4 v0, 0x0
