...
.method static getActionCompatFromAction(Landroid/app/Notification$Action;)Landroidx/core/app/NotificationCompat$Action;
    ...
    .line 8963
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api20Impl;->getRemoteInputs(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    .line 8970
    .local v3, "src":Landroid/app/RemoteInput;
    new-instance v4, Landroidx/core/app/RemoteInput;

    .line 8971
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api20Impl;->getResultKey(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v5

    .line 8972
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api20Impl;->getLabel(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v6

    .line 8973
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api20Impl;->getChoices(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v7

    .line 8974
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api20Impl;->getAllowFreeFormInput(Landroid/app/RemoteInput;)Z
    ...
    .line 8976
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api29Impl;->getEditChoicesBeforeSending(Landroid/app/RemoteInput;)I

    move-result v9

    .line 8978
    invoke-static {v3}, Landroidx/core/app/NotificationCompat$Api20Impl;->getExtras(Landroid/app/RemoteInput;)Landroid/os/Bundle;
    ...
    .line 8968
    .end local v3    # "src":Landroid/app/RemoteInput;
    ...
    .end local v1    # "remoteInputs":[Landroidx/core/app/RemoteInput;
    .end local v2    # "i":I
    .local v8, "remoteInputs":[Landroidx/core/app/RemoteInput;
    :goto_1
    nop

    .line 8985
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api20Impl;->getExtras(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    .line 8987
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api24Impl;->getAllowGeneratedReplies(Landroid/app/Notification$Action;)Z
    ...
    .line 8997
    .local v12, "showsUserInterface":Z
    nop

    .line 8998
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api28Impl;->getSemanticAction(Landroid/app/Notification$Action;)I

    move-result v11

    .line 9004
    .local v11, "semanticAction":I
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api29Impl;->isContextual(Landroid/app/Notification$Action;)Z
    ...
    .line 9008
    .local v13, "isContextual":Z
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api31Impl;->isAuthenticationRequired(Landroid/app/Notification$Action;)Z

    move-result v14

    .line 9010
    .local v14, "authRequired":Z
    nop

    .line 9011
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$Api23Impl;->getIcon(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
