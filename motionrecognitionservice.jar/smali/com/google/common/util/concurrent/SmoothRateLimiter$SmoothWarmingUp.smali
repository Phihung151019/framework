...
.method storedPermitsToWaitTime(DD)J
    ...
    .line 252
    .local v6, "permitsAboveThresholdToTake":D
    nop
    ...
    .line 254
    invoke-direct {p0, v10, v11}, Lcom/google/common/util/concurrent/SmoothRateLimiter$SmoothWarmingUp;->permitsToTime(D)D
    ...
    .line 259
    .end local v6    # "permitsAboveThresholdToTake":D
    .end local v8    # "length":D
    .end local p3    # "permitsToTake":D
    .local v0, "permitsToTake":D
    :cond_0
