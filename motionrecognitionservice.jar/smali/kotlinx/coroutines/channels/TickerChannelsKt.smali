...
.method public static final ticker(JJLkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/channels/TickerMode;)Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    invoke-virtual {v0, v7}, Lkotlinx/coroutines/CoroutineDispatcher;->plus(Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-static {v9, v10, v8, v4}, Lkotlinx/coroutines/channels/ProduceKt;->produce(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;ILkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    .line 65
    .local v4, "$i$a$-require-TickerChannelsKt$ticker$2":I
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "Expected non-negative initial delay, but has "
    ...
    .end local v4    # "$i$a$-require-TickerChannelsKt$ticker$2":I
    ...
    .line 64
    .local v4, "$i$a$-require-TickerChannelsKt$ticker$1":I
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "Expected non-negative delay, but has "
    ...
    .end local v4    # "$i$a$-require-TickerChannelsKt$ticker$1":I
    new-instance v5, Ljava/lang/IllegalArgumentException;
