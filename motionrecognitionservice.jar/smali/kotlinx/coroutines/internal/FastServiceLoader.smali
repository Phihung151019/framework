...
.method public final loadMainDispatcherFactory$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host()Ljava/util/List;
    ...
    .line 174
    .local v9, "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    move-object v10, v6

    .line 170
    .end local v9    # "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    :goto_0
    nop
    ...
    .line 63
    .local v10, "mainFactory":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    if-nez v10, :cond_1
    ...
    .restart local v3    # "serviceClass$iv":Ljava/lang/String;
    move-object v4, p0

    .restart local v4    # "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    const/4 v5, 0x0
    ...
    .line 179
    .local v7, "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    nop

    .line 175
    .end local v7    # "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    :goto_1
    nop
    ...
    .line 180
    .local v6, "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    const/4 v3, 0x0
    ...
    .end local v6    # "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    :cond_2
    nop

    .end local v1    # "result":Ljava/util/ArrayList;
    .end local v10    # "mainFactory":Lkotlinx/coroutines/internal/MainDispatcherFactory;
