...
.method public constructor <init>(Ljava/lang/String;Lkotlin/reflect/KClass;[Lkotlin/reflect/KClass;[Lkotlinx/serialization/KSerializer;)V
    ...
    const-string v6, "Multiple sealed subclasses of \'"
    ...
    const-string v5, "\' have the same serial name \'"
    ...
    .end local v15    # "accumulator":Ljava/util/Map$Entry;
    .end local v16    # "$i$a$-aggregate-SealedClassSerializer$2":I
    .end local v17    # "$i$f$aggregate":I
    .end local v18    # "destination$iv$iv":Ljava/util/Map;
    .restart local v5    # "$i$f$aggregate":I
    .restart local v6    # "destination$iv$iv":Ljava/util/Map;
    :cond_2
    move/from16 v17, v5
    ...
    .restart local v17    # "$i$f$aggregate":I
    nop
    ...
    .line 140
    .local v11, "$i$a$-mapValues-SealedClassSerializer$3":I
    ...
    .end local v11    # "$i$a$-mapValues-SealedClassSerializer$3":I
    ...
    const-string v4, "All subclasses of sealed class "
