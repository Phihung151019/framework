...
# static fields
.field private static final IS_JDM_PRODUCT:Z = false

.field private static final ONE_UI_VERSION_5_1_0:I = 0xc3b4

.field private static final ONE_UI_VERSION_6_0_0:I = 0xea60

.field private static final ONE_UI_VERSION_6_1_0:I = 0xeac4
...
.method public getAutoWifiCarrierFeature()Z
    .locals 3
    ...
    .line 5
    const-string v0, "CarrierFeature_Wifi_AutoWifi_DefaultOn"
    ...
    .line 9
    invoke-virtual {p0, v2, v0, v2, v1}, Lcom/samsung/android/feature/SemCarrierFeature;->getBoolean(ILjava/lang/String;ZZ)Z
...
.method public getAutoWifiDefaultValue()Z
    ...
    .line 8
    invoke-virtual {p0}, Lcom/samsung/android/server/wifi/SemFrameworkFacade;->isComcastVendor()Z
    ...
    .line 13
    .line 14
    invoke-virtual {p0}, Lcom/samsung/android/server/wifi/SemFrameworkFacade;->getAutoWifiCarrierFeature()Z
    ...
    .line 95
    .line 96
    invoke-virtual {p0}, Lcom/samsung/android/server/wifi/SemFrameworkFacade;->isATTVendor()Z
...
.method public getIlaConfiguration()I
    .locals 0
...
.method public getIwhConfiguration()I
    .locals 0
...
.method public isAutoWiFiEnableForATT()Z
    .locals 2
...
.method public isKtPadDevice()Z
    ...
    .line 5
    const-string v0, "CscFeature_Wifi_SupportHomeAPVSIE"
...
.method public isPlatformSigned(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 5
    const-string p1, "exception in checkSignature : "

    const-string p2, "SemFrameworkFacade"
...
.method public isWifiProfileShareAHSupported(Landroid/content/Context;)Z
    ...
    .line 8
    iput v0, p0, Lcom/samsung/android/server/wifi/SemFrameworkFacade;->mOneUIVersion:I
