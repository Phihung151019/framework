...
.method private addCommand([FCC[F)V
    ...
    .local v1, "currentX":F
    .local v12, "previousCmd":C
    .local v23, "k":I
    goto/16 :goto_8

    .line 740
    .end local v1    # "currentX":F
    .end local v12    # "previousCmd":C
    .end local v23    # "k":I
    ...
    .line 741
    invoke-virtual {v0, v9, v2}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->lineTo(FF)V
    ...
    invoke-virtual {v0, v1, v4, v6, v11}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->quadTo(FFFF)V

    .line 814
    add-float v1, v9, v3

    .line 815
    .end local v16    # "ctrlPointX":F
    .local v1, "ctrlPointX":F
    add-float v4, v2, v5

    .line 816
    .end local v17    # "ctrlPointY":F
    ...
    .restart local v16    # "ctrlPointX":F
    .restart local v17    # "ctrlPointY":F
    :sswitch_8
    const/4 v1, 0x0
    ...
    .local v11, "reflectiveCtrlPointX":F
    .local v12, "reflectiveCtrlPointY":F
    :goto_3
    add-float v1, v9, v11
    ...
    .end local v1    # "ctrlPointX":F
    .end local v3    # "currentY":F
    .end local v11    # "reflectiveCtrlPointX":F
    .end local v12    # "reflectiveCtrlPointY":F
    .local v2, "currentY":F
    .restart local v16    # "ctrlPointX":F
    .restart local v17    # "ctrlPointY":F
    :sswitch_9
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->quadTo(FFFF)V
    ...
    invoke-virtual {v0, v9, v2}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->moveTo(FF)V
    ...
    .line 733
    invoke-virtual {v0, v9, v13}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->lineTo(FF)V
    ...
    .end local v8    # "currentY":F
    .local v1, "currentY":F
    invoke-virtual {v0, v7, v1}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->lineTo(FF)V
    ...
    invoke-virtual {v0, v2, v3, v1, v4}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->quadTo(FFFF)V
    ...
    .local v7, "currentX":F
    .local v8, "currentY":F
    .restart local v12    # "previousCmd":C
    .restart local v23    # "k":I
    add-int/lit8 v1, v23, 0x0
    ...
    .end local v7    # "currentX":F
    .restart local v1    # "currentX":F
    invoke-virtual {v0, v1, v8}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->lineTo(FF)V
...
.method private drawArc(FFFFFFFZZ)V
    ...
    div-double v8, v8, v51

    const-wide/high16 v12, 0x3fd0000000000000L    # 0.25

    sub-double v53, v8, v12

    .line 884
    .local v53, "disc":D
    cmpg-double v0, v53, v5
    ...
    .line 895
    sub-double v12, v47, v55

    .line 896
    .local v12, "cx":D
    add-double v14, v49, v7
    ...
    .end local v14    # "cy":D
    :cond_2
    add-double v12, v47, v55

    .line 899
    .restart local v12    # "cx":D
    sub-double v14, v49, v7

    .line 902
    .restart local v14    # "cy":D
    :goto_0
    move-wide/from16 v16, v5

    sub-double v5, v37, v14

    move-wide/from16 v57, v3

    .end local v3    # "s":D
    .local v57, "s":D
    sub-double v3, v35, v12
    ...
    .line 904
    .local v27, "eta0":D
    sub-double v3, v41, v14

    sub-double v5, v39, v12
    ...
    .line 918
    .local v5, "tcx":D
    mul-double v16, v12, v31

    mul-double v18, v14, v33
    ...
    .local v13, "cx":D
    .local v15, "cy":D
    invoke-direct/range {v12 .. v30}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->arcToBezier(DDDDDDDDD)V
...
.method private getFloats(Ljava/lang/String;)[F
    ...
    invoke-direct {v4, v5}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath$ExtractFloatResult;-><init>(Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath-IA;)V
...
.method public fromSPR(Lcom/samsung/android/graphics/spr/document/SprInputStream;)V
    ...
    const-string v14, "unsupported command type:"
    ...
    .end local v6    # "endAngle":F
    .local v0, "x1":F
    .local v1, "y1":F
    .local v2, "x2":F
    .local v3, "y2":F
    .restart local v10    # "startAngle":F
    .restart local v11    # "endAngle":F
    :pswitch_2
    move v4, v1
    ...
    .end local v8    # "lastY":F
    .local v4, "lastY":F
    invoke-virtual {v1, v0, v2, v3, v4}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->quadTo(FFFF)V
    ...
    .end local v4    # "y1":F
    .local v2, "y1":F
    invoke-virtual {v1, v0, v2}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->lineTo(FF)V
    ...
    .end local v4    # "y1":F
    .local v2, "y1":F
    invoke-virtual {v1, v0, v2}, Lcom/samsung/android/graphics/spr/document/shape/SprObjectShapePath;->moveTo(FF)V
